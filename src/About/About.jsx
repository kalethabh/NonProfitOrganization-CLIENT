function About() {
  ...
  return (
    <div className="flex justify-center mt-4">
      <div className="bg-white p-6 rounded-lg shadow-2xl overflow-auto md:h-[43rem] lg:h-[40rem] md:w-[45em] lg:w-[100em] w-[22em] max-h-[35rem]">
        <h1 className="text-xl md:text-3xl lg:text-5xl font-bold mb-4">
          Acerca de nuestra organización sin fines de lucro
        </h1>
        <p className="text-gray-700 md:text-lg lg:text-2xl text-sm">
        ...
        <p className="text-gray-700 md:text-lg lg:text-2xl text-sm mt-4">
        ...
        <h1 className="mt-6 md:mt-4 text-md lg:text-2xl font-bold">DESARROLLADORES</h1>
        <ul className="list-disc list-inside mt-2">
          {developers.map((developer, index) => (
            <li key={index} className="text-gray-700 md:text-lg lg:text-2xl text-sm">
        ...
        <p className="text-gray-700 text-sm md:text-lg lg:text-2xl mt-4">
