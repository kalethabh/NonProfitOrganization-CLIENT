function About() {
  ...
  return (
    <div className="flex justify-center mt-4">
      <div className="bg-white p-6 rounded-lg shadow-2xl overflow-auto md:h-[43rem] lg:h-[35rem] md:w-[45em] lg:w-[80em] w-[22em] max-h-[42rem]">
        ...
        <p className="text-gray-700 md:text-lg text-sm mt-4">
        ...
        <h1 className="mt-6 md:mt-4 text-md font-bold">DESARROLLADORES</h1>
        ...
        <p className="text-gray-700 text-sm md:text-lg lg:text-lg mt-4">
